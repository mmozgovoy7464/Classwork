...
public class Book {
	...
	static public String[] conditions = {"Lucky! New Book!", "Uh, it's slightly worn!", "It's barely holding together at this point..."};
	...
	public void setDescription(int description) {
		this.description = conditions[description];
	}
